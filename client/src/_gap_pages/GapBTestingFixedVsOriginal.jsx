...
// v0 scaffold for: No A/B testing of fixed vs. original variants
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-b-testing-fixed-vs-original/run.

export default function BTestingFixedVsOriginalPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-b-testing-fixed-vs-original/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No A/B testing of fixed vs. original variants</h1>
