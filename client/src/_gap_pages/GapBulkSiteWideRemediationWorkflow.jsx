...
// v0 scaffold for: No bulk site-wide remediation workflow
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-bulk-site-wide-remediation-workflow/run.

export default function BulkSiteWideRemediationWorkflowPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-bulk-site-wide-remediation-workflow/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No bulk site-wide remediation workflow</h1>
