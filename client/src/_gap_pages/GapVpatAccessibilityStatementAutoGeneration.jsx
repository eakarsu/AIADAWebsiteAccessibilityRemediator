...
// v0 scaffold for: VPAT and accessibility-statement auto-generation
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-vpat-accessibility-statement-auto-generation/run.

export default function VpatAccessibilityStatementAutoGenerationPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-vpat-accessibility-statement-auto-generation/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>VPAT and accessibility-statement auto-generation</h1>
