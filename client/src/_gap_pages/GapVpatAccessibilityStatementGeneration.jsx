...
// v0 scaffold for: No VPAT / accessibility-statement generation
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-vpat-accessibility-statement-generation/run.

export default function VpatAccessibilityStatementGenerationPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-vpat-accessibility-statement-generation/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No VPAT / accessibility-statement generation</h1>
